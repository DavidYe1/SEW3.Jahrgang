...
public class Schuelerliste {
    ...
    private class MyIter implements SchuelerIterator {
        private final Schueler[] li; // ein array von objekten der klasse schueler
        private int index;
        ...
        private MyIter(Schueler[] l) {
            li = l.clone(); // erstellt ein neues schueler array gleicher groe�e und kopiert jedes einzelne element
            index = 0;
        }
        ...
        /**
         * zur abfrage, ob es ein n�chstes element gibt
         *
